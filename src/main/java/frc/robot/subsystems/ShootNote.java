...
public class ShootNote extends SubsystemBase {
  ...
  private CANSparkMax m_OutTopMotor;
  private CANSparkMax m_OutBottomMotor;
  //Vortex Motors, Flex Max -Intake to 
  private CANSparkMax m_IntakeTopMotor;
  private CANSparkMax m_IntakeBottomMotor;
  ...
  public ShootNote() {
    ...
    /*  InTake Top Motor */
    m_IntakeTopMotor =
        new CANSparkMax(Constants.Launcher.kInTopCanId, CANSparkLowLevel.MotorType.kBrushless);
